...
// Add this to your data.js file or include it in the page
...
// Add these methods to your data object in data.js
const data = {
    // ... your existing data methods ...
